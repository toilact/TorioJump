...
Một dự án trình diễn vật lý nhân vật 2D phong cách "Super Mario Arcade" kết hợp với các cơ chế **Troll (Unfair)** cực kỳ ức chế nhưng đầy thú vị. Dự án đã được nâng cấp với màn hình siêu rộng (Ultra-Wide) và nhạc nền 8-bit sống động.

---

## 🕹️ Tính năng mới cập nhật
- **Màn hình Ultra-Wide (1200x800)**: Tăng không gian trải nghiệm và quan sát.
- **Background Music (8-bit)**: Nhạc nền arcade cổ điển được tổng hợp trực tiếp từ code.
- **Hidden HUD Mode**: Tắt bảng chỉ số hệ thống để tăng độ khó và tính bất ngờ.
...
3. Chạy server:
   ...
   npm run dev
   ```
4. Mở trình duyệt tại: `http://localhost:5173` (hoặc port được thông báo)
...
- **Web Audio API**: Xử lý âm thanh & nhạc nền không cần file ngoài.

---

## ✍️ Tác giả
Dự án được thực hiện bởi **toilact** với tình yêu dành cho dòng game 2D Platformer.
